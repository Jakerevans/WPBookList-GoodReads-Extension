<?php
/**
 * WPBookList WPBookList_Goodreads_Update_Actual Class
 *
 * @author   Jake Evans
 * @category admin
...
if ( ! class_exists( 'WPBookList_Goodreads_Update_Actual', false ) ) :
	/**
	 * WPBookList_Goodreads_Update_Actual Class.
	 */
	class WPBookList_Goodreads_Update_Actual {
		...
		public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
			...
			if ( false === stripos( $this->extension_settings->jfsl, 'aod' ) ) {
				error_log('no dice!');
				return false;
			}
			 ...
			 */
			do_action( 'post_edd_sl_plugin_updater_goodreads_setup', $edd_plugin_data );
